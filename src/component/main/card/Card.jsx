...
export function Card() {
  return (
    <div className={style['assessmentSubCard']}>
                
                    <div className={style['content1']}>
                        <div className={style['subcontent1']}>
                            ...
                            <span className={style['math']}>Math Assessment</span>
                            <div>
                                <span className={style['job']}>Job</span>
                                <svg style={{marginLeft:'0.2rem', marginRight:'0.2rem'}} xmlns="http://www.w3.org/2000/svg" width="2" height="16" viewBox="0 0 2 16" fill="none">
                                ...
                                <span className={style['date']}>20 Apr 2023</span>
                            </div>
                        </div>
                        <div>
                            <svg className={style['svgdot']} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <svg className={style['svgdot1']} xmlns="http://www.w3.org/2000/svg" width="370" height="2" viewBox="0 0 356 2" fill="none">
                        <path d="M0 1H356" stroke="#DADCE0" stroke-dasharray="3 3" />
                    </svg>
                    <div className={style['subContent2']}>
                        <div className={style['subContent3']}>
                            <div style={{paddingBottom:'1rem',marginRight:'1.5rem'}}>
                                <span className={style['colorStyle']}>00</span>
                                <span className={style['colorStyle']} style={{position:'absolute',marginTop:"1rem",marginLeft:'-0.8rem'}}>Duration</span>
                            </div>
                            <div style={{paddingBottom:'1rem'}}>
                                <span className={style['colorStyle']}>00</span>
                                <span className={style['colorStyle']} style={{position:'absolute',marginTop:"1rem",marginLeft:'-0.8rem'}}>Questions</span>
                            </div>
                        </div>
                        <div className={style['subContent3']}>
                        <span className={style['button']}>
                            ...
                            <span className={style['colorStyle']}>Share</span>
                            </span>
                            <div>
                            <span className={style['lp']}>LP</span>
                            </div>
                        </div>
